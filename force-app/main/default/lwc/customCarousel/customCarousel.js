...
export default class CustomCarousel extends LightningElement {
    ...
    get maxWidth(){
        return this.showFull ? `width:100%;height:100%;`: `width:${Number(this.customWidth)}px;height:${Number(this.customWidth)}px`
    }

    get heightImg(){
        return this.showFull ? `height:100%`: `height:${Number(this.customWidth)}px`
    }
